package sa.rawan_alotaibi.sda.assigments.week6;
...
public class Week6Task2Test extends Tests {
    ...
    public Object[][] notes() throws IOException, InvalidFormatException {
        ...
        XSSFWorkbook myworkbook = new XSSFWorkbook(demoExcelFile);
        Object[][] data = null;

        try {
            XSSFSheet sheetPaper = myworkbook.getSheetAt(0);
            int numOfRows = 10;
            data = new Object[1][1];
            String[][] notes = new String[numOfRows][2];

            for (int i = 0; i < numOfRows; i++) {
                Row row = sheetPaper.getRow(i);
